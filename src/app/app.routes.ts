...
import {MangaProductsComponent} from "./israeli-products/manga-products/manga-products.component";
...
export const routes: Routes = [
  ...
  { path: 'israel-boycott-products', component: MangaProductsComponent },
